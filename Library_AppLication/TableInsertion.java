...
class TableInsertion
{
     ...
     private void addCategory()
     {
           try
             {
                   st.executeUpdate("INSERT INTO category (name) VALUES ('Fiction'),('Non-Fiction'),('Mystery'),('Science Fiction'),('Romance'),('Biography'),('History'),('Thriller'),('Fantasy');");                                
             }             
         catch(SQLException e)
             {
